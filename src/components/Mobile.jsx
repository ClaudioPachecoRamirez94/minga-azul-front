            ...
            <div className="flex justify-center items-center h-20">
              <div className="flex w-full mx-4 justify-between">
                <div className="flex items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20" stroke-width="1.5" stroke="#4338CA" class="w-8 h-8">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" /></svg>
                </div>
                <div>
                  <img className="xsm:w-12" src={logo} alt="asd" />
                </div>
              </div>
            </div>
            <div>
...
<footer class="bg-[#4338CA] sm:hidden md:hidden xl:hidden 2xl:hidden">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="https://flowbite.com/" class="flex items-center">
                  <img src={logo} class="h-10 mr-3" alt="FlowBite Logo" />
              </a>
          </div>
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <ul class="text-white font-medium">
                      ...
                      <li>
                          <a href="https://tailwindcss.com/" class="hover:underline">Mangas</a>
                      </li>
                  </ul>
              </div>
          </div>
      </div>
      <div class="xsm:flex xsm:items-center xsm:justify-center mt-6">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <div class="flex mt-4 space-x-6 xsm:justify-center sm:mt-0 text-white">
