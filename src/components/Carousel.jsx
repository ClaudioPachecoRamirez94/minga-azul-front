import deku_carousel from "../assets/images/deku_carousel.png";
import cover from "../assets/images/cover_carousel.png";
        ...
        <div className="flex justify-center mb-8 mt-10 pt-10 xsm:hidden">
          <div className="bg-cover bg-gradient-to-r from-[#4338CA] to-[#5E52F3] flex xsm:hidden w-[90vw] h-[25vh] justify-around rounded-lg gap-1">
            <div className="w-10 self-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF80" viewBox="0 0 24 24" stroke-width=".5" stroke="currentColor" class="w-12 h-10">
                <path stroke-linecap="round" stroke-linejoin="round" d="M11.25 9l-3 3m0 0l3 3m-3-3h7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <img className="self-center sm:h-[20vh] sm:w-30 sm:mb-8 lg:mb-14 md:h-48 md:mb-10 lg:h-80 " src={deku_carousel} alt="asd" />
            <img className="self-center sm:h-[25vh] sm:w-30 sm:mb-8 lg:mb-14 md:h-48 md:mb-10 lg:h-80 pb-5" src={cover} alt="asd" />
